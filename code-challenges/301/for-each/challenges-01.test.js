...
// I read this as adding the number to each element of the array at first, had to read the test to figure out what was intended

// const addValues = (arr, value) => {
//   return arr.map(n => n+value);
// }
...
//   return addNumbers(num, (callback(arr, num)), times - 1, callback);
// }
...
// This required adding an unused argument to removeOne to work with how callbacks are done with forEach
